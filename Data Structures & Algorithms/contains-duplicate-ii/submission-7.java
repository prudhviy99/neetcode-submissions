...
// should be i - lastseenIndex

// another solution is to use hashset and a sliding window of size k, we can just return true if the number is 
// within the window, if not we can keep moving the window